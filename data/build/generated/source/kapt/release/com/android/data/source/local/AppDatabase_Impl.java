  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `Content` (`id` INTEGER NOT NULL, `name` TEXT NOT NULL, `posterimage` TEXT NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '682e2cf1a0ac4f11f5d395f1984f4af8')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsContent = new HashMap<String, TableInfo.Column>(3);
        _columnsContent.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsContent.put("name", new TableInfo.Column("name", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsContent.put("posterimage", new TableInfo.Column("posterimage", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        final TableInfo _existingContent = TableInfo.read(db, "Content");
        if (!_infoContent.equals(_existingContent)) {
          return new RoomOpenHelper.ValidationResult(false, "Content(com.android.data.source.local.entity.PhotoEntity).\n"
                  + " Expected:\n" + _infoContent + "\n"
                  + " Found:\n" + _existingContent);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "682e2cf1a0ac4f11f5d395f1984f4af8", "99ab0871eabe73a560850f23a82bbc59");
