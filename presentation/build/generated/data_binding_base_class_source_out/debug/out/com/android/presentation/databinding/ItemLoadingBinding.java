...
public final class ItemLoadingBinding implements ViewBinding {
  ...
  private ItemLoadingBinding(@NonNull ConstraintLayout rootView, @NonNull ProgressBar progressBar) {
  ...
  public static ItemLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemLoadingBinding((ConstraintLayout) rootView, progressBar);
    }
